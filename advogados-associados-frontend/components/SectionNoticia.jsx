...
export default function SectionNoticia(props) {
    ...
    <div className="container is-light">
        <div className="columns boxshadow mb-5 text">
            ...
            <div className="column is-9 px-6 py-3">
            <Link href={ "/noticiasInterna?id=" + props.id }>
                <a href="#">
                    ...
                    <p dangerouslySetInnerHTML={{ __html: props.new.slice(0, 500) }} className="subtitle is-size-5 is-size-6-mobile text-notice-space"></p>
                </a>
            </Link>
            </div>
        </div>
